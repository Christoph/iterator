...
let html = '<h1>Token usage'+(D.plan?' \u2014 '+esc(D.plan):'')+'</h1>'+
  '<p class="hint">Raw token counts plus optional project-owned prices. Rates are USD per one million tokens; missing rates display \u2014 instead of estimating provider costs.</p>';
...
function priceEditor(models){
  return '<section class="price-box"><div class="price-head"><div><h2>Model prices</h2><p>Optional USD rates per 1M tokens. Saving replaces this project\u2019s complete price table.</p></div></div>'+
