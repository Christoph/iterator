...
.panel{border:1px solid var(--border);border-radius:10px;background:var(--surface);padding:16px;margin:0 0 18px}
.hero{display:grid;gap:14px}.hero h2,.panel h2{font-size:18px;margin:0 0 4px}.hero p,.hint,.muted{color:var(--text-muted)}
.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:10px}
.metrics div{border:1px solid var(--border);border-radius:8px;padding:10px;background:var(--bg)}
.metrics strong{display:block;font-size:17px}.metrics span{font-size:12px;color:var(--text-muted)}
.metrics .warn strong{color:var(--dot-yellow)}
.actions,.card-actions,.tile-foot,.section-head{display:flex;gap:8px;align-items:center;flex-wrap:wrap}
.section-head{justify-content:space-between}
.actions button,.card-actions button,.tile-foot button,.section-head button{font-size:13px;padding:4px 12px;
  border-radius:5px;border:1px solid var(--border);cursor:pointer;background:var(--surface);color:var(--text);font-family:inherit}
...
.tile,.memory-card{border:1px solid var(--border);border-radius:8px;background:var(--bg);padding:12px}
.tile h3,.memory-card h3{margin:0;font-size:15px}
.tile p,.memory-card p{color:var(--text-muted);font-size:13px;margin:5px 0}
.tile-foot{justify-content:space-between;margin-top:10px;color:var(--text-muted);font-size:12px}
.memory-group{margin-top:12px}
.card-head{display:flex;align-items:center;gap:8px;justify-content:space-between}
.status{font-size:10px;text-transform:uppercase;border-radius:12px;padding:2px 8px;border:1px solid var(--border);color:var(--text-muted)}
.badge-stale{font-size:10px;font-weight:700;letter-spacing:.5px;border-radius:4px;padding:2px 6px;
  background:var(--bg-yellow);color:var(--dot-yellow)}
.meta{font-size:12px;color:var(--text-muted);margin:5px 0}
.meta code{font-size:11px;margin-right:4px;background:var(--code-bg);border-radius:4px;padding:1px 5px;
  font-family:ui-monospace,Menlo,monospace}
.request-box{display:grid;gap:8px}
...
.memory-comment{margin:8px 0;min-height:58px;font-size:13px}
`;
