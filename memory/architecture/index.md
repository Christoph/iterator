...
* [Browser server contract](/architecture/browser-server-contract.md) - Interactive workflows use a one-result server contract; Pi's persistent shell owns cancellation across iframe navigation.
