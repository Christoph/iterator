...
* [Plan](plan.md) - Start each implementation in a minimal fresh session and make Work the single active-plan surface with clear red-test and modal settings state.
