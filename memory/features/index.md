...
* [Backlog file mentions](backlog-file-mentions.md) - ✅ done · small · Add Planning-style @ file suggestions to backlog idea details so candidates can anchor repository context.
* [Reliable backlog saves](backlog-save-during-work.md) - ✅ done · medium · Keep deterministic backlog saves available during active work without clearing the owned Work overlay.
