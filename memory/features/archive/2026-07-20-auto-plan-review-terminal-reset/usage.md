...
| model | input | output | cache read | cache write | turns | cost |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| openai-codex/gpt-5.6-terra | 0 | 0 | 0 | 0 | 3 | — |
...
| retire-plan | 0 | 0 | 0 | 0 | 3 | — |

Total: 2040732 in / 21484 out / 15654400 cache-read / 0 cache-write over 75 turns. Cost unavailable: add every used model rate.
