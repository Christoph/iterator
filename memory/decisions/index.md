...
* [Powerline shows the sandbox-published UI port](/decisions/powerline-shows-sandbox-ui-port.md) - The footer trails a ui:PORT segment read from ITERATOR_DISPLAY_PORT, so each sandboxed agent shows which host port its UI answers on.
