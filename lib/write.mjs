...
function cancelPlan(payload, root) {
	...
	if (planBranch) {
		...
		if (
			cur !== planBranch &&
			!notes.some((n) => n.includes("inside the plan worktree"))
		) {
			try {
